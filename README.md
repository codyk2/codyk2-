...
- **Incoming Data Engineer Intern @ SpaceX** — Test Reliability team (McGregor, TX) · Summer 2026
- **Research Assistant @ Baylor SMART Hub** — Building Dynamic Spectrum Access systems to protect military radar in the 3.1–3.45 GHz band
- **ECS Ambassador** — Baylor School of Engineering & Computer Science

### 💼 Experience

**Software Engineering Co-op · Keysight Technologies**  
Developed a Particle Swarm Optimization framework for RF circuit design automation, built 3D visualization tools, and integrated solutions with Keysight's ADS platform.

**Research · Baylor SMART Hub**  
Created Django-based spectrum sharing systems with real-time interference calculations and CBRS messaging protocols for military radar protection.
...
- 🏊 Training for the **Half Ironman Waco**
- 🎓 **Delta Tau Delta** fraternity
- 📈 Exploring entrepreneurship & networking platforms
